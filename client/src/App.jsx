...
import { Upload, FileAudio, Play, Pause, Copy, Check, Download, Loader2 } from 'lucide-react';
...
function App() {
    ...
    const handleTranscribe = async () => {
        ...
        try {
            // In production (Docker), this hits the FastAPI backend on the same origin
        ...
        <div className="min-h-screen p-8 flex flex-col items-center">
            <header className="w-full max-w-4xl mb-12 text-center">
                ...
                <p className="text-slate-400 text-lg">
                    Premium AI Speech-to-Text with Timestamps
                </p>
            </header>
